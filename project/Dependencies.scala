...
object Dependencies {
  ...
  lazy val scalacheck: ModuleMap =  sv => scalacheckGroup(sv) % "scalacheck" % scalacheckVersion(sv) % "test" cross CVMapping282
  ...
  val inflector = "io.backchat.inflector" %% "scala-inflector" % "1.3.5" cross CrossVersion.full
