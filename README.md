...
For the native support add the following dependency to your project description:
    ...
    val json4sNative = "org.json4s" %% "json4s-native" % "3.2.6"
...
* http://repo1.maven.org/maven2/org/json4s/3.2.6/json4s-ast_2.10-3.2.6.jar
* http://repo1.maven.org/maven2/org/json4s/3.2.6/json4s-core_2.10-3.2.6.jar
* http://repo1.maven.org/maven2/org/json4s/3.2.6/json4s-native_2.10-3.2.6.jar
